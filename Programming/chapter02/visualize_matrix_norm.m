...
function drawGUI()
    ...
    handle_plot.x.current   = line([0 0], [0 0], 'Color', color_x, 'LineWidth', 2); hold on;
    ...
    handle_plot.x.maximizer = plot(0, 0, 'o', 'Color'          , color_x, ...
                                              'MarkerFaceColor', [0.90 0.55 0.45], ...
                                              'MarkerSize'     , 10, ...
                                              'Visible'        , 'off'); hold on;
    ...
    handle_plot.y.current   = line([0 0], [0 0], 'Color', color_y, 'LineWidth', 2); hold on;
    ...
    handle_plot.y.maximizer = plot(0, 0, 'o', 'Color'          , color_y, ...
                                              'MarkerFaceColor', [0.25 0.60 0.70], ...
                                              'MarkerSize'     , 10, ...
                                              'Visible'        , 'off');
